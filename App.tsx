...
import LycheeCharacter from './components/LycheeCharacter';
import { Tab, TimerMode, TimerSettings } from './types';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (isActive && timeLeft > 0) {
      ...
      // Fixed: Use nextMode instead of mode to ensure the alert shows the completed state correctly
